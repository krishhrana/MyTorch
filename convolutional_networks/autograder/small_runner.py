...
def test_upsampling_1d_correctness():
    ...
    expected_res = np.load(
        'ref_result/upsample_1d_res.npz',
        allow_pickle=True)
...
def test_downsampling_1d_correctness():
    ...
    expected_res = np.load(
        'ref_result/downsample_1d_res.npz',
        allow_pickle=True)
...
def test_upsampling_2d_correctness():
    ...
    expected_res = np.load(
        'ref_result/upsample_2d_res.npz',
        allow_pickle=True)
...
def test_downsampling_2d_correctness():
    ...
    expected_res = np.load(
        'ref_result/downsample_2d_res.npz',
        allow_pickle=True)
...
def test_convTranspose_1d_correctness():
    ...
    expected_res = np.load(
        'ref_result/convTranspose_1d_res.npz',
        allow_pickle=True)
...
def test_convTranspose_2d_correctness():
    ...
    expected_res = np.load(
        'ref_result/convTranspose_2d_res.npz',
        allow_pickle=True)
...
def test_MaxPool2d_stride1_correctness():
    ...
    expected_res = np.load(
        'ref_result/maxpool2d_stride1_res.npz',
        allow_pickle=True)
...
def test_simple_scanning_mlp():
    data = np.loadtxt(
        os.path.join('data', 'data.asc')).T.reshape(
        1, 24, -1)
