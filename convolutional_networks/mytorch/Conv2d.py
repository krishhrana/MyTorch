...
class Conv2d_stride1():
    ...
    def backward(self, dLdZ):
        ...
        self.dLdW = dLdW  # TODO
        self.dLdb = np.sum(dLdZ, axis=(0, 2, 3))  # TODO  # TODO
        self.dLdA = dLdA
...
class Conv2d():
    def __init__(self, in_channels, out_channels, kernel_size, stride,
        ...
        self.conv2d_stride1 = Conv2d_stride1(in_channels, out_channels, kernel_size, weight_init_fn,
                                             bias_init_fn)  # TODO
        self.downsample2d = resampling.Downsample2d(stride)  # TODO
    ...
    def forward(self, A):
        ...
        # downsample
        Z = self.downsample2d.forward((Z_1))  # TODO
    ...
    def backward(self, dLdZ):
        ...
        dLdA = self.conv2d_stride1.backward(dLdA_1)  # TODO
