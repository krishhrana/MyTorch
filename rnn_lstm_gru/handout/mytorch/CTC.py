...
class CTCLoss(object):
    ...
    def forward(self, logits, target, input_lengths, target_lengths):
        ...
        for batch_itr in range(B):
            ...
            ctc = CTC()
            cross_entropy = loss.SoftmaxCrossEntropy()
    ...
    def backward(self):
        ...
        for batch_itr in range(B):
            ...
            # Truncate the target to target lengt
...
'''    
[[[-1.86958303e+00 -7.84310792e-01  0.00000000e+00 ...  0.00000000e+00
    0.00000000e+00  0.00000000e+00]
  [-8.50044039e-01 -4.12862764e-01  0.00000000e+00 ...  0.00000000e+00
    0.00000000e+00  0.00000000e+00]'''


''' [[[-1.86958303e+00 -7.84310792e-01  0.00000000e+00 ...  0.00000000e+00
    0.00000000e+00  0.00000000e+00]
  [-8.92686856e-01 -7.70086949e-01  0.00000000e+00 ...  0.00000000e+00
    0.00000000e+00  0.00000000e+00]'''
